...
public class InMemoryBackupPathChangeStatusMapRepository
    ...
    @Override
    public SortedMap<Change, Long> countsByStatus(final @NonNull BackupPathChangeStatusMapId id) {
    ...
    public Change getOrDefault(
            @NonNull final BackupPathChangeStatusMapId id,
            @NonNull final BackupPath path,
            @NonNull final Change defaultValue) {
