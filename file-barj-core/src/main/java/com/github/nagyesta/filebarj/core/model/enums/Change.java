...
public enum Change {
     ...
     */
    NEW(true, false, false, false, "File not found in backup."),
    /**
     ...
     */
    CONTENT_CHANGED(true, false, true, true, "Failed to restore file content."),
    /**
     * The file was present in previous backups and was changed to an older version since the last
     * backup.
     */
    ROLLED_BACK(false, true, true, true, "Failed to restore file content."),
    /**
     * The file was present in the previous backup, but it is missing now (probably because it got
     * deleted).
     */
    DELETED(false, false, true, true, "Missing, could not be restored.");

    private final boolean storeContent;
    private final boolean linkPreviousContent;
     ...
     * @param linkPreviousContent  true if the previous content should be linked during incremental
     *                             backup creation
    ...
    Change(final boolean storeContent,
        ...
        this.linkPreviousContent = linkPreviousContent;
