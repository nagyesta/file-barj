...
class BackupIncrementMetadataReaderAndWriterTest {
    ...
    @ParameterizedTest
    @ValueSource(strings = {
            "/backups/ubuntu-backup-1707595719.manifest.cargo.json",
            "/backups/ubuntu-backup-1708783849.manifest.cargo.json",
            "/backups/ubuntu-backup-1708783920.manifest.cargo.json",
            "/backups/ubuntu-backup-1708783987.manifest.cargo.json",
            "/backups/ubuntu-backup-1708856935.manifest.cargo.json",
    ...
    void testReadAndThenWriteShouldReproduceTheInitialJsonWhenCalledWithValidFile(final String resourceName) throws Exception {
        ...
        final var expectedValue = objectMapper.reader().readValue(jsonContent, Map.class);
        final var actualValue = objectMapper.reader().readValue(outputBuilder.toString(), Map.class);
