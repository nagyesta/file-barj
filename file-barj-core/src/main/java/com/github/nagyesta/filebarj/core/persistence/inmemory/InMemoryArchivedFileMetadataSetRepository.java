...
public class InMemoryArchivedFileMetadataSetRepository
    ...
    public void appendTo(
            @NonNull final ArchivedFileMetadataSetId id,
            @NonNull final Collection<ArchivedFileMetadata> values) {
    ...
    @Override
    public void removeFileSet(@NonNull final ArchivedFileMetadataSetId id) {
    ...
    public Set<UUID> containsFileMetadataIds(
            @NonNull final ArchivedFileMetadataSetId id,
            @NonNull final Collection<UUID> fileMetadataIds) {
        return getFileSetById(id)
                .stream()
                .map(ArchivedFileMetadata::getFiles)
    ...
    public ArchivedFileMetadataSetId intersectWithFileMetadata(
        ...
        final var dataRepositories = DataRepositories.IN_MEMORY;
        dataRepositories.getFileMetadataSetRepository()
                .forEach(fileMetadataSetId,
                        dataRepositories.getSingleThreadedPool(),
                        metadata -> appendTo(result, archivedMetadataByFileId.get(metadata.getArchiveMetadataId())));
        return result;
    }
