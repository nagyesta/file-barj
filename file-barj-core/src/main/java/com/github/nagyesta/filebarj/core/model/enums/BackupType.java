...
public enum BackupType {
     ...
     * <br/>
     * Ignores previous backups of the same state. Mandatory after configuration
     * changes.
     */
    FULL,
    /**
     ...
     * <br/>
     * The previous increment may be either a {@link #FULL} or {@code INCREMENTAL}
     * backup. The current increment will consider only the changes since the last
